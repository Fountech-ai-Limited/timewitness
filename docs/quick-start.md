...
line from the `v0.3` release, and that is most of the wait. `scripts/walk-the-quick-start.py` runs
...
```sh
cargo install --locked --git https://github.com/Fountech-ai-Limited/timewitness --tag v0.3 timewitness-cli
```
